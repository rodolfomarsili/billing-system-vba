VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} form_RecargarInventario 
   Caption         =   "Recargar Inventario"
   ClientHeight    =   6810
   ClientLeft      =   120
   ClientTop       =   468
   ClientWidth     =   11868
   OleObjectBlob   =   "form_RecargarInventario.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "form_RecargarInventario"
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''Verificaciones'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    If a = 0 Then
        MsgBox "No hay productos agregados a la factura", , "Recargo de inventario"
        Exit Sub
    End If
    
    'Verificacion de comentario obligatorio
    If (TextBox_Comentario.Text = Empty) Then
        MsgBox "Agrega un comentario a esta transaccion para tener una referencia futura", , "Recargo de inventario"
        Exit Sub
    End If
    
        'Ultima verificacion antes de procesar la factura
    ProcesarFactura = MsgBox("¿Seguro que deseas procesar esta transaccion?", vbYesNo + vbExclamation, "Recargo de inventario")
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''Procesar Descuento'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    'Añadir las existencias en el inventario para cada producto de la factura
    For i = 0 To a - 1
    ...
    For i = a - 1 To 0 Step -1
        ...
        IncluirEnHistorial Frame_Correlativo, Label_CorrelativoPrefijo, Fecha, Codigo, Producto, "BRL", Cantidad, TextBox_Comentario.Text, , IDResponsable, Costo, , NuevaExistencia
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''Limpieza de Formulario'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    MsgBox "Transaccion realizada exitosamente", , "Recargo de inventario"
...
Private Sub UserForm_Initialize()
    ...
    Label_CorrelativoPrefijo.Caption = "Recargo"
